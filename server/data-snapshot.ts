...
export async function dataSnapshot(input: { issues_per_status?: unknown; include_issues?: unknown } = {}) {
  ...
  const issueGroups = includeIssues ? await listIssueGroups({}, issueDisplayLimit) : [];
  return {
